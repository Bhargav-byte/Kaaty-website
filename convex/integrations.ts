...
export const seed = mutation({
  handler: async (ctx) => {
    ...
    const integrations = [
      ...
      { name: 'Swiggy', slug: 'swiggy', icon: 'bike', dot: '#FC8019', order: 6 },
      { name: 'Zomato', slug: 'zomato', icon: 'utensils', dot: '#E23744', order: 7 },
      { name: 'ONDC', slug: 'ondc', icon: 'network', dot: '#1F8A5B', order: 8 },
    ]
